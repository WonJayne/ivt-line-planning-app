...
from ..modelling import BusLine, PlanningScenario, Station
from .demand import load_demand_matrix
from .line import LineFactory, equalise_travel_times_per_link, load_lines_from_json
...
def load_scenario(parameters: LinePlanningParameters, paths: ScenarioPaths) -> PlanningScenario:
    ...
    equalised_lines = equalise_travel_times_per_link(raw_lines)
